...
#import "KCLAbstractDatabaseLogger.h"
#import <math.h>
...
@interface KCLAbstractDatabaseLogger ()
...
@implementation KCLAbstractDatabaseLogger
...
- (BOOL)db_log:(KCLLogMessage *)logMessage {
    return NO;
}
